...
const PendingFeedbackTable = ({ pendingFeedbacks, activeSection }) => {
  return (
              ...
              {pendingFeedbacks.map((feedback) => (
                <tr key={feedback.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <Link
                      to={`/feedback/${feedback.id}/assignment-${feedback.id}`}
                    ...
                    <button
                      ...
                      onClick={() => alert(`AI Feedback for ${feedback.student} approved!`)}
                    >
                      Approve AI Feedback
                    </button>
                  </td>
...
export default PendingFeedbackTable